...
insert
  OVERWRITE table dm_acsp.account_manager_monthly_middle PARTITION(inc_month = '202003')
select emp_name, emp_code, curr_area, position_name, hire_date, job_name, job_id, all_rmb, total_month_target, all_get, all_rank, new_sign_rmb, new_month_target, new_get, new_rank, maint_rmb, maint_month_target, maint_get, maint_rank from base_message